...
export function Contact() {
  ...
  return (
    <section id="speak-with-us" className="bg-[#0A0A0A] py-16 sm:py-28 md:py-36 relative overflow-hidden border-t border-white/5">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-charcoal-light/40 via-charcoal to-[#0A0A0A] z-0 pointer-events-none" />
      ...
      <div className="max-w-[1400px] mx-auto px-5 sm:px-12 relative z-10">
        <div className="mb-8 sm:mb-16">
          ...
          <p className="text-bone/80 text-xs sm:text-base md:text-lg font-sans font-light leading-relaxed max-w-2xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-12 xl:gap-16 items-start">
          ...
          {/* Left: Form */}
          <div className="lg:col-span-7 bg-charcoal-light/80 p-5 sm:p-12 border border-white/10 shadow-2xl relative rounded-[2px]">
            ...
            <p className="text-bone/60 text-[11px] sm:text-xs font-sans mb-5 sm:mb-8">Fill in your details and a Gogia Group director will reach out shortly.</p>

            {submitted ? (
              <div className="p-6 sm:p-8 bg-gold/10 border border-gold/30 text-center rounded-[2px] my-6 sm:my-12">
                <div className="text-gold font-serif text-xl sm:text-2xl mb-2">Callback Request Received</div>
                <p className="text-bone/80 text-xs sm:text-sm font-sans">Thank you. Senior advisory team from Gogia Group will get in touch with you promptly.</p>
              </div>
            ) : (
              <form className="space-y-4 sm:space-y-6" onSubmit={handleSubmit}>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                  <div>
                    ...
                    <input 
                      type="text" 
                      required
                      className="w-full bg-black/40 border border-white/10 focus:border-gold outline-none text-ivory px-3.5 sm:px-4 min-h-[42px] sm:min-h-[48px] text-[13px] sm:text-[16px] font-sans transition-colors rounded-[2px]" 
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                  <div>
                    ...
                    <select className="w-full bg-black/40 border border-white/10 focus:border-gold outline-none text-ivory px-3.5 sm:px-4 min-h-[42px] sm:min-h-[48px] text-[13px] sm:text-[16px] font-sans transition-colors rounded-[2px] appearance-none">
                ...
                <div>
                  ...
                  <textarea 
                    rows={3} 
                    className="w-full bg-black/40 border border-white/10 focus:border-gold outline-none text-ivory p-3.5 sm:p-4 text-[13px] sm:text-[16px] font-sans transition-colors resize-none placeholder-white/20 rounded-[2px]" 
                ...
                <button 
                  type="submit" 
                  className="w-full h-[44px] sm:h-[52px] bg-gold text-charcoal text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.2em] sm:tracking-[0.25em] hover:bg-ivory transition-colors duration-300 shadow-xl rounded-[2px]"
                >
                  REQUEST CALLBACK
                </button>
              </form>
          ...
          <div className="lg:col-span-5 space-y-6 sm:space-y-8">
            <div className="bg-charcoal-light/50 p-5 sm:p-8 border border-white/10 rounded-[2px] space-y-4 sm:space-y-6">
              <h4 className="text-lg sm:text-xl font-serif text-ivory">Direct Contact</h4>
              <p className="text-bone/70 text-[11px] sm:text-xs font-sans leading-relaxed">
            ...
            <div className="bg-charcoal-light/50 p-5 sm:p-8 border border-white/10 rounded-[2px] space-y-4 sm:space-y-6">
              <div className="space-y-4 sm:space-y-6">
                ...
                <div className="flex items-start gap-3 sm:gap-4 pt-3 sm:pt-4 border-t border-white/5">
